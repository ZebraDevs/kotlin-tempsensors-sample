...
interface IZebraSensorService {
    ...
    */
    ...
    /**
    * Get an {@link com.zebra.ichabodservice.IZebraSensor} object representing the discovered sensor.&nbsp;
    ...
    * @return {@link com.zebra.ichabodservice.IZebraSensor} representing the sensor with an ID matching the sensor ID
    ...
    */
    ...
    /**
    * Return true if the service has an auth token set, return false if auth token is missing.&nbsp;
